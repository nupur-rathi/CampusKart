// Implements the search by owner function
...
class SearchResultOwner extends StatefulWidget {
  const SearchResultOwner({Key? key}) : super(key: key);

  @override
  _SearchResultOwnerState createState() => _SearchResultOwnerState();
}

class _SearchResultOwnerState extends State<SearchResultOwner> {
    ...
    return Scaffold(
      body: FloatingSearchBar(
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            await productsP.fetchOwnerProducts(selectedTerm);
            setState(() {
        ...
        onSubmitted: (query) async {
          await productsP.fetchOwnerProducts(query);
          addSearchTerm(query);
          setState(() {
            selectedTerm = query;
            searchedProducts = productsP.products;
                    ...
                    return Column(
                      ...
                      children: filteredSearchHistory
                          .map((term) => ListTile(
                                ...
                                onTap: () async {
                                  await productsP.fetchOwnerProducts(term);
                                  putSearchTermFirst(term);
                                  setState(() {
                                    selectedTerm = term;
                                  });
